const abi = [{ inputs: [{ internalType: 'string', name: 'name', type: 'string' }, { internalType: 'string', name: 'symbol', type: 'string' }, { internalType: 'string', name: 'baseURI', type: 'string' }], stateMutability: 'nonpayable', type: 'constructor' }, {
  anonymous: false,
  inputs: [{
  ...
  inputs: [{
    ...
    indexed: false, internalType: 'uint256', name: 'childTokenId', type: 'uint256',
  }, {
  ...
  inputs: [{
    ...
    indexed: false, internalType: 'uint256[]', name: 'childTokenIds', type: 'uint256[]',
  }, {
  ...
  inputs: [{ internalType: 'uint256', name: 'tokenId', type: 'uint256' }, { internalType: 'address', name: 'childContract', type: 'address' }, { internalType: 'uint256', name: 'childTokenId', type: 'uint256' }], name: 'childBalance', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function',
}, {
  inputs: [{ internalType: 'uint256', name: 'tokenId', type: 'uint256' }], name: 'childContractsFor', outputs: [{ internalType: 'address[]', name: '', type: 'address[]' }], stateMutability: 'view', type: 'function',
}, {
  inputs: [{ internalType: 'uint256', name: 'tokenId', type: 'uint256' }, { internalType: 'address', name: 'childContract', type: 'address' }], name: 'childIdsForOn', outputs: [{ internalType: 'uint256[]', name: '', type: 'uint256[]' }], stateMutability: 'view', type: 'function',
}, {
